...
print("=============================")
print("Bem vindo ao jogo Papel, Pedra e Tesousa")

def main_print():
    print("===================================")
    print("\nPlacar:")
    print("Você: {}".format(player_count))
    print("Computado: {}".format(computer_count))
    print("\n")
    print("Escolha seu lance:")
    print("0 - Papel | 1 - Pedra | 2 - Tesousa")
...
while again == 1:
    ...
    os.system("cls") # clear se for Linux ou Mac
